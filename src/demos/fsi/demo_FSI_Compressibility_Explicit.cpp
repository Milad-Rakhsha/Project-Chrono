...
#include "demos/fsi/demo_FSI_Compressibility_Explicit.h"  //SetupParamsH()
...
const std::string h_file =
    "/home/milad/CHRONO/Project-Chrono-Milad-IISPH/src/demos/fsi/demo_FSI_Compressibility_Explicit.h";
const std::string cpp_file =
    "/home/milad/CHRONO/Project-Chrono-Milad-IISPH/src/demos/fsi/demo_FSI_Compressibility_Explicit.cpp";

const std::string out_dir = "FSI_OUTPUT";  //"../FSI_OUTPUT";
const std::string pov_dir_fluid = out_dir + "/Compressibility_Explicit";
