...
#include "demos/fsi/demo_MultiPhysics.h"  //SetupParamsH()
...
// =============================================================================
const std::string out_dir = GetChronoOutputPath() + "MultiPhysics";
...
double Indentor_R = 0.01;
double Indentaiton_rate = -000.0 * 1e-6;
double x0 = bzDim;
...
void Create_MB_FE(ChSystemSMC& mphysicalSystem, fsi::ChSystemFsi& myFsiSystem, chrono::fsi::SimParams* paramsH) {
    ...
    if (addCable) {
        ...
        for (int Fiber = 0; Fiber < num_Fibers; Fiber++) {
            ...
            double loc_z = Fiber_Length + initSpace0;
