...
#include "demos/fsi/demo_FSI_Poiseuille_flow.h"  //SetupParamsH()
...
//----------------------------
const std::string h_file = "/home/milad/CHRONO/Project-Chrono-Milad-IISPH/src/demos/fsi/demo_FSI_Poiseuille_flow.h";
const std::string cpp_file = "/home/milad/CHRONO/Project-Chrono-Milad-IISPH/src/demos/fsi/demo_FSI_Poiseuille_flow.cpp";

const std::string out_dir = "FSI_OUTPUT";  //"../FSI_OUTPUT";
const std::string pov_dir_fluid = out_dir + "/Poiseuille_flow/";
...
void CreateMbdPhysicalSystemObjects(ChSystemParallelDVI& mphysicalSystem,
    ...
    // Bottom wall
    ChVector<> sizeBottom(bxDim / 2, byDim / 2, 2 * paramsH->HSML);
