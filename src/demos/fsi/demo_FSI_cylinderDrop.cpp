...
void CreateMbdPhysicalSystemObjects(ChSystemParallelDVI& mphysicalSystem,
    ...
    // beginning third
    chrono::fsi::utils::AddBoxBce(myFsiSystem.GetDataManager(), paramsH, ground, pos1, rot1, size1);

    // end third
    chrono::fsi::utils::AddBoxBce(myFsiSystem.GetDataManager(), paramsH, ground, pos2, rot2, size2);

    // basin
    chrono::fsi::utils::AddBoxBce(myFsiSystem.GetDataManager(), paramsH, ground, pos3, rot3, size3);

    // slope 1
    chrono::fsi::utils::AddBoxBce(myFsiSystem.GetDataManager(), paramsH, ground, pos4, rot4, size4);

    // slope 2
    chrono::fsi::utils::AddBoxBce(myFsiSystem.GetDataManager(), paramsH, ground, pos5, rot5, size5);
