...
void DoStepFluid_implicit(
	...
	IntegrateSPH_implicit(derivVelRhoD, posRadD2, velMasD2, rhoPresMuD2, posRadD,
			velMasD, rhoPresMuD, bodyIndexD, referenceArray,
...
//			velMassRigid_fsiBodies_D2, omegaVelLRF_fsiBodies_D2, numObjects);
	...
	IntegrateSPH_implicit(derivVelRhoD, posRadD, velMasD, rhoPresMuD, posRadD2, velMasD2,
			rhoPresMuD2, bodyIndexD, referenceArray,
