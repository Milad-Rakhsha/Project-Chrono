...
enum PPE_SolutionType {
	IterativeJacobi, SPARSE_MATRIX_JACOBI
};
/**
...
struct SimParams {
	...
	Real tweakMultV; /* maximum allowed velocity: tweakMultV * HSML / dT;  NOTE: HSML and dT must be defined. So this line
	 comes after them */
