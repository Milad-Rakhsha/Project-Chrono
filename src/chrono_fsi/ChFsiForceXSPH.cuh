...
#ifndef CH_FSI_FORCEXSPH_H_
#define CH_FSI_FORCEXSPH_H_
...
class CH_FSI_API ChFsiForceXSPH : public ChFsiForce {
  public:
    ChFsiForceXSPH(ChBce* otherBceWorker,                   ///< Pointer to the ChBce object that handles BCE markers
  ...
  private:
    void ForceSPH(SphMarkerDataD* otherSphMarkersD,
